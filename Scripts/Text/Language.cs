...
public class GameText
{
    ...
    public const string TITLE_ATTRIBUTE_MDMG_REDUCTION_RATE = TEXT_PREFIX + "TITLE_ATTRIBUTE_MDMG_REDUCTION_RATE";
    public const string TITLE_ATTRIBUTE_ALLDMG_REDUCTION_RATE = TEXT_PREFIX + "TITLE_ATTRIBUTE_ALLDMG_REDUCTION_RATE";
    ...
    public const string TITLE_ATTRIBUTE_COUNTER_CHANCE = TEXT_PREFIX + "TITLE_ATTRIBUTE_COUNTER_CHANCE";
    public const string TITLE_ATTRIBUTE_COUNTER_DAMAGE_RATE = TEXT_PREFIX + "TITLE_ATTRIBUTE_COUNTER_DAMAGE_RATE";
    // Warn
